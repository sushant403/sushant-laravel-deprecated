...
<form action="php/uresume.php" method="post">
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      ...
      <input type="text" name="title" class="form-control" id="website" placeholder="Bachelors Of Computer Application" required>
    </div>
    <div class="form-group col-md-8">
              ...
              <div class="modal-body" id="skilleditbox">
                <form action="php/uresume.php" method="post">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                      <label for="sn">Course/Position Name</label>
                      <input type="text" name="title" value="<?= $data2['title'] ?>" class="form-control" id="website" placeholder="Bachelors Of Computer Application" required>
                    </div>
                    <div class="form-group col-md-8">
                      <label for="website">Institute or Company Name</label>
                      <input type="text" name="ogname" value="<?= $data2['ogname'] ?>" class="form-control" id="website" placeholder="" required>
                    </div>
                    <div class="form-group col-md-4">
                      <label for="website">Duration or Time Period</label>
