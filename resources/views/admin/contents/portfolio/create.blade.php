        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                    ...
                    <form action="{{ route("sushant.portfolio.store") }}" method="POST" class="form-validate"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="portfolio_url" class="form-control"
                                        placeholder="https://preludeint.com" required id="portfolio_url" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="short_desc" class="form-control"
                                        placeholder="Short Description about the job." id="short_desc"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
