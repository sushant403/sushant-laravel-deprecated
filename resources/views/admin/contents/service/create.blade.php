        ...
        <div class="card-body">
            <ul class="nav nav-pills" role="tablist">
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab"
                        ...
                        <i data-feather="user"></i><span class="d-none d-sm-block">Service Details</span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                    ...
                    <form action="{{ route("sushant.service.store") }}" method="POST" class="form-validate"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="title" name="title" class="form-control"
                                        placeholder="Laravel Development" required id="title" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="short_desc" class="form-control" required
                                        placeholder="Short Description about the service." id="short_desc"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="long_desc">Long Description</label>
                                    <textarea name="long_desc" class="form-control" required
                                        placeholder="You may ellobarate a bit." id="long_desc"></textarea>
                                </div>
                            </div>

                            <div class="col-8">
                                <div class="form-group {{ $errors->has('photo') ? 'has-error' : '' }}">
                                    <label for="photo">Upload Service Image</label>
