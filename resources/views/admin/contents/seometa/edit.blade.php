    ...
    <div class="card-body">
      <ul class="nav nav-pills" role="tablist">
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account"
            ...
            <i data-feather="user"></i><span class="d-none d-sm-block">MetaTags Details</span>
          </a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
          ...
          <form action="{{ route("sushant.seometa.update", 1) }}" method="POST" class="form-validate"
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input value="{{ old('meta_title', $seometa->meta_title) }}" type="text" class="form-control"
                    name="meta_title" placeholder="Meta Title" required id="meta_title" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="meta_url">Meta URL</label>
                  <input value="{{ old('meta_url', $seometa->meta_url) }}" type="text" name="meta_url"
                    class="form-control" placeholder="Meta URL Info." required id="meta_url" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="meta_author">Meta Author</label>
                  <input value="{{ old('meta_author', $seometa->meta_author) }}" type="text" name="meta_author"
                    class="form-control" placeholder="Author's Name" required id="meta_author" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="meta_description" class="form-control"
                    placeholder="Short Description about the website." required id="meta_description"></textarea>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="meta_keywords" class="form-control"
                    placeholder="portfolio, service, resume, sushantpoudel" required id="meta_keywords"></textarea>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="date_from">META Image URL</label>
                  <input value="{{ old('meta_image_url', $seometa->meta_image_url) }}" type="text" name="date_from"
                    class="form-control" placeholder="URL of the Image" required id="date_from" />
                </div>
              </div>
