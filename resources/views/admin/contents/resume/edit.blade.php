    ...
    <div class="card-body">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
          ...
          <form action="{{ route("sushant.resume.update", [$resume->id]) }}" method="POST" class="form-validate"
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input value="{{ old('title', $resume->title) }}" type="title" name="title" class="form-control"
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input value="{{ old('company', $resume->company) }}" type="text" name="company" class="form-control"
                    placeholder="Company's Name" required id="company" />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="short_desc" class="form-control" placeholder="Short Description about the job."
                    required id="short_desc">{{ old('short_desc', $resume->short_desc) }}</textarea>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="long_desc">Long Description</label>
                  <textarea name="long_desc" class="form-control" placeholder="You may ellobarate a bit." required
                    id="long_desc">{{ old('long_desc', $resume->long_desc) }}</textarea>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="date_from">Date (From)</label>
                  <input value="{{ old('date_from', $resume->date_from) }}" type="text" name="date_from"
                    class="form-control" placeholder="May 2020" required id="date_from" />
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="date_to">Date (To)</label>
                  <input value="{{ old('date_to', $resume->date_to) }}" type="text" name="date_to" class="form-control"
                    placeholder="August 2020" required id="date_to" />
                </div>
              </div>
