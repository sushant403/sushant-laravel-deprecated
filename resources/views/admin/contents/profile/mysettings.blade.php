...
@section('page-style')
<!-- Page css files -->
<link rel="stylesheet" href="{{ asset('admin-assets/css/base/plugins/forms/pickers/form-pickadate.css') }}">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="account-company" name="company"
                                                placeholder="Company name" value="Crystal Technologies" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mt-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-md-3 text-center mb-1">
                                                ...
                                                <div class="avatar mb-1">
                                                    <span class="avatar-content">
                                                        <img src="{{asset('images/avatars/11-small.png')}}"
                                            ...
                                            <div class="col-6 col-md-3 text-center mb-1">
                                                ...
                                                <div class="avatar mb-1">
                                                    <span class="avatar-content">
                                                        <img src="{{asset('images/avatars/3-small.png')}}"
                                                            alt="avatar img" width="40" height="40" />
                                                    </span>
                                                </div>
