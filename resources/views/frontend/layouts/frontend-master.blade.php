...
<head>
    ...
    @include('frontend.components.meta-tags')
    <!-- Stylings -->
                    ...
                    <div class="dtr-header-right">
                        <div class="main-navigation dtr-menu-dark">
                            <ul class="sf-menu dtr-scrollspy dtr-nav dark-nav-on-load dark-nav-on-scroll">
                                @auth<li> <a class="nav-link" href="{{ route('sushant.index') }}">Hey Sushant, Wanna come in?</a> </li>@endauth
                                <li> <a class="nav-link" href="{{ !request()->is('/') ? '/' : '#home' }}">Home</a> </li>
                                <li> <a class="nav-link" href="{{ !request()->is('/') ? '/about' : '#about' }}">About</a> </li>
